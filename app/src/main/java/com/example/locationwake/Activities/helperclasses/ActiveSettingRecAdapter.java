...
public class ActiveSettingRecAdapter extends RecyclerView.Adapter{
    ...
    public class headerViewHolder extends RecyclerViewExpandebleItem {
    ...
    public class LocationViewHolder extends RecyclerViewExpandebleItem implements OnMapReadyCallback {
    ...
    public class DistanceViewHolder extends RecyclerViewExpandebleItem {
