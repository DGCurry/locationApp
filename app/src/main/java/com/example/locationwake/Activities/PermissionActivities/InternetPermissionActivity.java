...
public class InternetPermissionActivity extends Permission {

    //TAG of the class
    static final private String TAG = "InternetPermissionActivity";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        int permissionI = INTERNET_PERMISSION_CODE;
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("ok", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ActivityCompat.requestPermissions(InternetPermissionActivity.this,
