...
//
//import com.example.locationwake.Activities.HelperClasses.ListLocationsRecAdapter;
...
//        recyclerView = (RecyclerView) findViewById(R.id.recyclerView_list_setting);
//        recyclerView.setHasFixedSize(true);
//        layoutManager = new LinearLayoutManager(this);
//        recyclerView.setLayoutManager(layoutManager);
//        mAdapter = new ListLocationsRecAdapter(list, getApplicationContext());
